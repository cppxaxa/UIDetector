...
if __name__ == '__main__':
    ...
    input_path_img = 'gui_sample.png'
    # input_path_img = 'gui_sample_2.png'
    output_root = 'out'
    ...
    if is_ocr:
        ...
        text.text_detection(input_path_img, output_root, show=True, method='paddle', paddle_model=paddle_model)
